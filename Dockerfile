...
RUN cp -r /app/ca9e858e.000 /var/opt/cprocsp/keys/root &&\
    ...
    /opt/cprocsp/bin/amd64/certmgr -inst -store mMy -thumbprint 9665de1cb14ce98a15bf9217add65560b5350860 -file /app/test.cer -cont '\\.\HDIMAGE\ca9e858e6-4a61-c61a-159e-e750ff4c00b' -pin 1234567890
WORKDIR /app
